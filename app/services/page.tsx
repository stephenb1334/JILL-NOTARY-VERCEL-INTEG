  ...
  return (
    <>
      ...
      <div className="relative w-full h-[400px] md:h-[500px] lg:h-[600px]">
        <Image
          src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/jill-notary-about%20us%20background%20banner.jpg-A4OnHtfH5cEOp1kuijAahJI2XJBl3n.jpeg"
          alt="Services banner"
          fill
          priority
          sizes="100vw"
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-4">
          <h1 className="text-3xl font-bold tracking-tighter font-heading text-neutral-900 sm:text-4xl md:text-5xl mb-4">
            Our Notary Services
          </h1>
          <p className="text-neutral-800 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed max-w-[700px] mx-auto">
