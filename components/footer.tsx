    ...
    <footer className="bg-neutral-800 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">NotariesBy</h3>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start">
                ...
                <div>
                  <p className="font-medium">info@notariesby.com</p>
        ...
        <div className="mt-12 pt-8 border-t border-neutral-700 text-center text-sm text-neutral-400">
          <p>&copy; {new Date().getFullYear()} NotariesBy. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
